...
env_up(){
    ...
    aws cloudformation create-stack --stack-name cwp-demo-stack --template-url https://$BUCKET_NAME.s3-$REGION_CODE.amazonaws.com/main-new.yaml --parameters  ParameterKey=S3Bucket,ParameterValue=$BUCKET_NAME  --capabilities CAPABILITY_NAMED_IAM CAPABILITY_IAM CAPABILITY_AUTO_EXPAND --region $REGION_CODE
    echo -e "The Cloudformation stack will take 8-12 minutes to complete$NC"
